...
namespace moth::bridge {
    UiWindow::UiWindow(std::unique_ptr<moth_graphics::platform::Window> window)
    ...
    void UiWindow::PushLayer(std::unique_ptr<moth_ui::Layer> layer) {
    ...
    void UiWindow::PostCreate() {
        ...
        m_layerStack = std::make_unique<moth_ui::LayerStack>(*m_uiRenderer, size, size);
