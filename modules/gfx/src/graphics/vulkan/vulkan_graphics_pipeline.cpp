...
namespace {
    VkVertexInputBindingDescription getVertexBindingDescription() {
        ...
        vertexBindingDesc.stride = sizeof(moth::gfx::graphics::vulkan::Graphics::Vertex);
    ...
    std::vector<VkVertexInputAttributeDescription> getVertexAttributeDescriptions() {
        ...
        vertexAttributeDescs[0].offset = offsetof(moth::gfx::graphics::vulkan::Graphics::Vertex, xy);

        vertexAttributeDescs[1].binding = 0;
        vertexAttributeDescs[1].location = 1;
        vertexAttributeDescs[1].format = VK_FORMAT_R32G32_SFLOAT;
        vertexAttributeDescs[1].offset = offsetof(moth::gfx::graphics::vulkan::Graphics::Vertex, uv);
        ...
        vertexAttributeDescs[2].offset = offsetof(moth::gfx::graphics::vulkan::Graphics::Vertex, color);
    ...
    VkVertexInputBindingDescription getFontVertexBindingDescription() {
        ...
        vertexBindingDesc.binding = 0;
        vertexBindingDesc.stride = sizeof(moth::gfx::graphics::vulkan::Graphics::FontGlyphInstance);
    ...
    std::vector<VkVertexInputAttributeDescription> getFontVertexAttributeDescriptions() {
        ...
        vertexAttributeDescs[0].location = 0;
        vertexAttributeDescs[0].format = VK_FORMAT_R32G32_SFLOAT;
        vertexAttributeDescs[0].offset = offsetof(moth::gfx::graphics::vulkan::Graphics::FontGlyphInstance, pos);

        vertexAttributeDescs[1].binding = 0;
        vertexAttributeDescs[1].location = 1;
        vertexAttributeDescs[1].format = VK_FORMAT_R32_UINT;
        vertexAttributeDescs[1].offset = offsetof(moth::gfx::graphics::vulkan::Graphics::FontGlyphInstance, glyphIndex);

        vertexAttributeDescs[2].binding = 0;
        vertexAttributeDescs[2].location = 2;
        vertexAttributeDescs[2].format = VK_FORMAT_R32_SFLOAT;
        vertexAttributeDescs[2].offset = offsetof(moth::gfx::graphics::vulkan::Graphics::FontGlyphInstance, rotation);
        ...
        vertexAttributeDescs[3].offset = offsetof(moth::gfx::graphics::vulkan::Graphics::FontGlyphInstance, color);
