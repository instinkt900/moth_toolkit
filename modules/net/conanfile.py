...
class MothNet(ConanFile):
    ...
    def requirements(self):
        # Messages are framed length-prefixed JSON (nlohmann_json already a core
        # dep); asio is the standalone, header-only transport.
    ...
    def package_info(self):
        self.cpp_info.set_property("cmake_target_name", "moth::net")
        self.cpp_info.libs = ["moth_net"]
