...
TEST_CASE("FloatMat4x4 Rotation 90 degrees around origin", "[transform]") {
    auto const t = FloatMat4x4::Rotation(DegToRad(90.0f), { 0.0f, 0.0f });
...
TEST_CASE("FloatMat4x4 Rotation 180 degrees around origin", "[transform]") {
    auto const t = FloatMat4x4::Rotation(DegToRad(180.0f), { 0.0f, 0.0f });
...
TEST_CASE("FloatMat4x4 Rotation around non-origin pivot", "[transform]") {
    ...
    auto const t = FloatMat4x4::Rotation(DegToRad(90.0f), { 1.0f, 1.0f });
    auto const p = t.TransformPoint({ 1.0f, 0.0f });
...
TEST_CASE("FloatMat4x4 composition applies rhs first", "[transform]") {
    ...
    auto const rotate    = FloatMat4x4::Rotation(DegToRad(90.0f), { 0.0f, 0.0f });
...
TEST_CASE("FloatMat4x4 GetRotation round-trips", "[transform]") {
    for (float deg : { 0.0f, 45.0f, 90.0f, 135.0f, -45.0f, -90.0f }) {
        auto const t = FloatMat4x4::Rotation(DegToRad(deg), { 0.0f, 0.0f });
        REQUIRE(t.GetRotation() == Catch::Approx(DegToRad(deg)).margin(1e-4f));
    }
}
...
TEST_CASE("FloatMat4x4 Invert undoes rotation", "[transform]") {
    auto const t   = FloatMat4x4::Rotation(DegToRad(45.0f), { 0.0f, 0.0f });
    auto const inv = t.Invert();
...
TEST_CASE("FloatMat4x4 Invert undoes Translation * Rotation", "[transform]") {
    auto const t   = FloatMat4x4::Translation({ 10.0f, 5.0f }) * FloatMat4x4::Rotation(DegToRad(30.0f), { 5.0f, 5.0f });
    auto const inv = t.Invert();
