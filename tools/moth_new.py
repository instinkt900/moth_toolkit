...
def main() -> int:
    ...
    print()
    print("Before building, make sure the moth modules are in your local Conan cache:")
    print("  (from the moth_toolkit repo)")
    print("  conan create modules/core --build=missing -s build_type=Release")
    print("  conan create modules/gfx  --build=missing -s build_type=Release")
    print()
    print("Next steps:")
